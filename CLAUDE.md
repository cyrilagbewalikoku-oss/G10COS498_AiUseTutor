...
**Never explain first and ask questions after.** The nudge must come before the explanation, and it must ask the learner to predict, reason, or commit to a position — not just "any thoughts?" This mid-task reflection is woven naturally into the conversation — it feels like dialogue, not evaluation.
